...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    {
      title: t('dashboard.productsForRent'),
      value: stats?.products_for_rent || 0,
      icon: Package,
      color: 'bg-primary/10 text-primary',
    },
    {
      title: t('dashboard.productsForSale'),
      value: stats?.products_for_sale || 0,
      icon: ShoppingBag,
  ...
  const alertCards = [
    // Only show pending deposits to admins
    ...(isAdmin ? [{
